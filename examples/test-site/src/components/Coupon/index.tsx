...
import { StylableProps, DesignableComponentsProps, Div, P, Img, designable, addClasses } from '@bodiless/fclasses';
...
const Coupon: FC<Props> = ({ components }) => {
    const { CouponImage, Description, Header, ImageWrapper, Wrapper } = components;
